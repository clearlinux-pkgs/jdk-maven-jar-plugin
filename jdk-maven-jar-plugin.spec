...
License  : Apache-2.0
Requires: jdk-maven-jar-plugin-data
...
%package data
Summary: data components for the jdk-maven-jar-plugin package.
Group: Data

%description data
data components for the jdk-maven-jar-plugin package.


%prep
%setup -q -n maven-jar-plugin-3.0.2

%build
python3 /usr/share/java-utils/mvn_build.py -f -- -DmavenVersion=3.1.1

%install
xmvn-install  -R .xmvn-reactor -n maven-jar-plugin -d %{buildroot}
